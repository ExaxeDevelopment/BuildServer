class deployRelease_HansardV2 implements Serializable {
    def getDeploySteps() { 
		...
		//Exaxe.SystemConfiguration - DeployWebApi
		...
		//Exaxe.Apex.Workflow  - DeployWebApi
		...
		clientWsPublishMap.put("Project", "Exaxe.Client-WCF"); 
		...
		policyWsPublishMap.put("Project", "Exaxe.AdminPlus-WCF"); 
