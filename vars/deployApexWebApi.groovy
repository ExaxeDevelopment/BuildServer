class deployApexWebApi implements Serializable {
    def getDeploySteps() { 
		...
		/// WEB SITES
		//Exaxe.Apex - GetCodeLatestVersion
		Map<String,String> apexWebApiGetCodeMap  = new HashMap<String,String>();
		apexWebApiGetCodeMap.put("Project", "Exaxe.Apex"); 
		apexWebApiGetCodeMap.put("Operation", "GetCodeLatestVersion"); 
		deploySteps.add(apexWebApiGetCodeMap);

		//Exaxe.Apex - RestoreNuGetPackages
		Map<String,String> apexWebApiRestoreNugetMap  = new HashMap<String,String>();
		apexWebApiRestoreNugetMap.put("Project", "Exaxe.Apex"); 
		apexWebApiRestoreNugetMap.put("Operation", "RestoreNuGetPackages"); 
		deploySteps.add(apexWebApiRestoreNugetMap);
		
		//Exaxe.Apex - PublishWebSite
		Map<String,String> apexWebApiPublishMap  = new HashMap<String,String>();
		apexWebApiPublishMap.put("Project", "Exaxe.Apex"); 
