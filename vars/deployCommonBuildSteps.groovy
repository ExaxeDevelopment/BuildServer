    ...
    def getDeployCommonBuildSteps(val) { 
		...
		switch (val) {
			...
			case "DeployRelease_OneFamilyV2":
				...
				commonDeploySteps = deployRelease_OneFamilyV2Class.getDeploySteps();
                break			
			case "DeployRelease_PoliceMutual":
                ...
                break			
			case "DeployRelease_PoliceMutualV2":
                def deployRelease_PoliceMutualV2Class = new deployRelease_PoliceMutualV2();
				commonDeploySteps = deployRelease_PoliceMutualV2Class.getDeploySteps();
                break			
