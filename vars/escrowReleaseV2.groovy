class escrowReleaseV2 implements Serializable {
    def getEscrowSteps() { 
		...
		deploySteps.add(getStep("Exaxe.Configuration.WCF"));
		deploySteps.add(getStep("Exaxe.WCF"));
		deploySteps.add(getStep("Automation"));
		deploySteps.add(getStep("SolutionManager"));
		deploySteps.add(getStep("Exaxe.AppMonitoring"));
		deploySteps.add(getStep("Hansard.Portals"));
