class deployPolicyEbi implements Serializable {
    def getDeploySteps() { 
		...
		//Exaxe.PolicyEBI  - BuildDatabase
		Map<String,String> policyEbiDbMap = new HashMap<String,String>();
		policyEbiDbMap.put("Project", "Exaxe.PolicyEBI"); 
		policyEbiDbMap.put("Operation", "BuildDatabase"); 
		deploySteps.add(policyEbiDbMap);

		/// WEB SERVICES
		//Exaxe.PolicyEBI  - PublishWebService
		Map<String,String> policyEbiWsPublishMap = new HashMap<String,String>();
		policyEbiWsPublishMap.put("Project", "Exaxe.PolicyEBI"); 
		policyEbiWsPublishMap.put("Operation", "PublishWebService"); 
		...
		existingBusinessUIGetCodeMap.put("Operation", "GetCodeLatestVersion"); 
		deploySteps.add(existingBusinessUIGetCodeMap);

		//ExistingBusinessUI - PublishWebSite
		Map<String,String> existingBusinessUIPublishMap  = new HashMap<String,String>();
		existingBusinessUIPublishMap.put("Project", "ExistingBusinessUI"); 
		existingBusinessUIPublishMap.put("Operation", "PublishWebSite"); 
		deploySteps.add(existingBusinessUIPublishMap);
