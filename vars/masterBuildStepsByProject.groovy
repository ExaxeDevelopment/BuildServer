class masterBuildStepsByProject implements Serializable {
    ...
    def getMasterBuildStepsByProject(masterBuildType, firstProject) { 
        ...
        switch (masterBuildType) {
			...
			case "MasterBuildReleaseV25_3":
                ...
                break	
			case "MasterBuildReleaseV25_8":
                buildSteps = getMasterBuildReleaseV25_8();
                break	
			case "MasterBuildReleaseV25_9":
                buildSteps = getMasterBuildReleaseV25_9();
                break	
			case "MasterBuildReleaseV25_12":
                buildSteps = getMasterBuildReleaseV25_12();
                break	
			case "MasterBuildReleaseV26_3":
                buildSteps = getMasterBuildReleaseV26_3();
                break	
			case "MasterBuildReleaseV26_7":
                buildSteps = getMasterBuildReleaseV26_7();
                break	
			case "MasterBuildReleaseV26_9":
                buildSteps = getMasterBuildReleaseV26_9();
                break	
	...
	private List<String> getMasterBuildReleaseV25_8(){
		List<String> buildItems = getMasterBuildV2ReleaseVXX_X("25.8");
	
		//// Commented deployments can be re-added if the customer/environment must be included.
	
		buildItems.add("Deploy-Release-Police-Exaxe-Single-V25.8");
		buildItems.add("DeletePackages");
		buildItems.add("ClearNuGetCachePackages");
	...
	private List<String> getMasterBuildReleaseV25_9(){
		List<String> buildItems = getMasterBuildV2ReleaseVXX_X("25.9");

		buildItems.add("Build-Hansard.Portals-Release-V25.9"); 	
	
		buildItems.add("Deploy-Release-Hansard-Exaxe-Single-V25.9");
		buildItems.add("Deploy-Release-Hansard-Exaxe-Multi-V25.9");
		buildItems.add("Deploy-Release-Hansard-Multi-V25.9");
		buildItems.add("Deploy-Release-Hansard-Single-V25.9");
		buildItems.add("DeletePackages");
		buildItems.add("ClearNuGetCachePackages");
	...
	private List<String> getMasterBuildReleaseV25_12(){
		...
		buildItems.add("Deploy-Release-Hansard-Multi-V25.12");
		buildItems.add("Deploy-Release-Hansard-Exaxe-Multi-V25.12");
		buildItems.add("Deploy-Release-Hansard-Exaxe-Single-V25.12");
		buildItems.add("Deploy-Release-Hansard-Single-V25.12");
		buildItems.add("DeletePackages");
		buildItems.add("ClearNuGetCachePackages");
	...
	private List<String> getMasterBuildReleaseV26_3(){
		...
		buildItems.add("Deploy-Release-Hansard-Single-V26.3");
		buildItems.add("DeletePackages");
		buildItems.add("ClearNuGetCachePackages");
	...
	private List<String> getMasterBuildReleaseV26_7(){
		...
		buildItems.add("Deploy-Release-Hansard-Exaxe-Single-V26.7");
		buildItems.add("Deploy-Release-Hansard-Exaxe-Multi-V26.7");
		buildItems.add("Deploy-Release-Hansard-Multi-V26.7");
		buildItems.add("Deploy-Release-Hansard-Single-V26.7");
		buildItems.add("DeletePackages");
		buildItems.add("ClearNuGetCachePackages");
	...
	private List<String> getMasterBuildReleaseV26_9(){
		List<String> buildItems = getMasterBuildV2ReleaseVXX_X("26.9");
	
		//// Commented deployments can be re-added if the customer/environment must be included.
	
		buildItems.add("Deploy-Release-Police-Exaxe-Single-V26.9");
		buildItems.add("DeletePackages");
		buildItems.add("ClearNuGetCachePackages");
