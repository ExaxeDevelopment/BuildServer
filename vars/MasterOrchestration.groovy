...
def getIntegrationSteps(buildFromStage, buildToStage){
	...
	Map<String,String> map04 = new HashMap<String,String>();
	map04.put("MasterBuild-Apex-Dev001", APPEX_I_BUILD_SERVER)	
	map04.put("MasterBuild-WebServices-Dev001", API_I_BUILD_SERVER)	
	steps.put("APEX/Web Services", map04);
...
def getSuperBuildSteps(buildFromStage, buildToStage){
	...
	Map<String,String> map04 = new HashMap<String,String>();
	map04.put("MasterBuild-AdminPlus-Dev002", ADMIN_PLUS_BUILD_SERVER)
	map04.put("MasterBuild-AdvicePlus-Dev002", ADVICE_PLUS_BUILD_SERVER)
	map04.put("MasterBuild-Apex-Dev001", APEX_BUILD_SERVER)	
